// File: js/app.js
// Student: Noor Maher Hajji (12428944)
...
document.addEventListener("DOMContentLoaded", async function () {
  ...
  try {
    ...
    console.error(error);
    setStatus(error.message || "Error loading tasks", true);
  }
});
 ...
 */
 ...
 if (form) {
  ...
  throw new Error("Could not add task");
      ...
      console.error(error);
      setStatus(error.message || "Error adding task", true);
    }
  });
}
...
// Suggested helper (you can modify it or make your own):
  ...
  throw new Error("Could not delete task");
      ...
      console.error(error);
      setStatus(error.message || "Error deleting task", true);
    }
  });
